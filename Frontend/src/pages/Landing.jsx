    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="container mx-auto px-4 py-16 grid md:grid-cols-2 gap-10 items-center">
        <div>
          <h1 className="text-5xl font-bold mb-6 text-gray-900">
            Your Digital Reading Destination
          </h1>
          <p className="text-xl text-gray-600 mb-8">
            Explore an endless library of eBooks, read anywhere, anytime on any
            device with instant access to your favorite titles.
          </p>
        ...
        <div className="flex justify-center items-center">
          <div className="relative">
            <TabletIcon className="w-96 h-96 text-blue-100" />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              <BookOpenIcon className="mx-auto mb-4 w-12 h-12 text-blue-600" />
              <h3 className="text-xl font-semibold mb-3">Vast Library</h3>
              <p className="text-gray-600">
                Access thousands of eBooks across multiple genres and
                categories.
              </p>
            </div>
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              <TabletIcon className="mx-auto mb-4 w-12 h-12 text-green-600" />
              <h3 className="text-xl font-semibold mb-3">
                Multi-Device Support
              </h3>
              <p className="text-gray-600">
                Read on smartphones, tablets, computers, and e-readers.
              </p>
            </div>
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              <HeartIcon className="mx-auto mb-4 w-12 h-12 text-red-600" />
              <h3 className="text-xl font-semibold mb-3">
                Personalized Experience
              </h3>
              <p className="text-gray-600">
                Customize your reading with bookmarks, highlights, and
                recommendations.
              </p>
            </div>
          </div>
      ...
      <section className="bg-blue-600 text-white py-16 text-center">
        ...
        <p className="text-xl mb-8">
          Unlock a world of knowledge and entertainment with just a click.
        </p>
      ...
      <footer className="bg-gray-900 text-white py-12">
        ...
        <div className="container mx-auto px-4 mt-8 text-center text-gray-400 border-t border-gray-800 pt-6">
          © 2025 eBook. All Rights Reserved.
        </div>
      </footer>
    </div>
  );
